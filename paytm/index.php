...
<body>
    ...
    <input id="INDUSTRY_TYPE_ID" name="INDUSTRY_TYPE_ID" type="text" value="WEB" />
    </div>
    <div class="form-control">
    ...
    <input type="hidden" id="TXN_AMOUNT" name="TXN_AMOUNT" value="1" />
    </div>
    <div class="form-control">
        <input type="hidden" name="CALLBACK_URL" value="http://localhost/Delivery/paytm/success.php"/>
    </div>
